    ...
    <footer className="bg-[#0A0A0F] text-white py-8 mt-12">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center text-xs text-white/60 mt-8">
          © {new Date().getFullYear()} <span className="text-primary">AIVisionContest</span> All rights reserved. Brought to you by <Link to="https://winberghmedia.com" className="hover:text-primary transition-colors">Winbergh Media</Link>.
        </div>
      </div>
    </footer>
  );
